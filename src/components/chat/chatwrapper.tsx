...
import { ArrowRight, ChevronLeft, Loader2, XCircle } from "lucide-react";
      ...
      <div className="relative min-h-full bg-zinc-50 flex divide-y divide-zinc-200 flex-col justify-between gap-2">
        <div className="flex-1 flex flex-col justify-center items-centermb-28">
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="text-zinc-500 text-sm">
              Your <span className="font-medium">Free</span>{" "} plan supports up to 10 pages per PDF
            </p>
...
<Link href='/dashboard'>
  <div className="cursor-pointer p-3 rounded-lg mt-2 bg-zinc-200 flex items-center">
